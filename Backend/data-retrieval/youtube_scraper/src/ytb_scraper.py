...
def save_transcript(video_id, file_name):
    """
...
if __name__ == "__main__":
    ...
    if max_transcripts:
        videos = videos[:max_transcripts]

    print(f"Saving transcripts for {channel_name}...")
    cnt = 0
    for i, video in enumerate(tqdm(videos)):
        ...
        # save transcript
        success = save_transcript(video["ID"], output_file)
